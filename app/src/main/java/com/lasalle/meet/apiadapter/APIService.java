...
//    Call<Event> getUserFriend(@Field("ID") int ID);
    ...
    Call<List<Event>> getFutureUserEvent(@Path("ID") int ID,@Header("Authorization") String Token);
    @GET("users/{ID}/events/finished")
    Call<List<Event>> getFinishedUserEvent(@Path("ID") int ID,@Header("Authorization") String Token);
    @GET("users/{ID}/events/current")
    Call<List<Event>> getCurrentUserEvent(@Path("ID") int ID,@Header("Authorization") String Token);
